 ...
 *
 * Error fixed by Waqas Malik on 05 October 2016 .
 * Fix is made on the following line 
 * query += (column + ((index < columnNames.length - 1) ? ', ' : ' '));
 * this line of code has bee fixed as it was causing error ( Error Example: (e.g. Error at select ,) )
 * Error Cause: due to absence of proper parenthesis, column weren't property added and an invalid query was generated 
 * Invalid Query Sample: "Select , from [tableName]"
 */
