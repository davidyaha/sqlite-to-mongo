...
SqliteToMongo.prototype._handleSqliteRow = function (collectionName, tableMapping, err, row) {
  ...
  assign(newDoc, (tableMapping.presets) ? tableMapping.presets : {});
 ...
 * }
 */
SqliteToMongo.prototype.importCollection = function (collectionName, tableMapping) {
  ...
  this.sqliteDb.each(query, this._handleSqliteRow.bind(this, collectionName, tableMapping));
};
